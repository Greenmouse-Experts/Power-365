    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Unsuccessful Users</h1>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h3 class="card-title">All Unsuccessful Users</h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive export-table">
                                <table id="basic-datatable" class="table table-bordered key-buttons border-bottom w-100">
                                    <thead>
                                        <tr> 
                                    ...
                                    @if($unsuccessful_users->isEmpty())
                                    <tbody>
                                        <tr>
                                            <td class="align-enter text-dark font-15" colspan="6">No Unsuccessful User.</td>
                                        </tr>
                                    </tbody>
                                    @else
                                    @foreach($unsuccessful_users as $key => $user)
                                    <tbody>
                                        <tr>
